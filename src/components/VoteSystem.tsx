...
export const VoteSystem: React.FC = () => {
  ...
  return (
    <section id="vote" className="py-16 sm:py-32 px-6 relative overflow-hidden bg-white/5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="ios-card flex flex-col items-center justify-center space-y-10 bg-white"
          >
            <h3 className="text-xl font-bold flex items-center space-x-3 text-black">
            ...
            <div className="flex items-center space-x-16">
              <div className="flex flex-col items-center space-y-4">
                <button
                  ...
                  className={cn(
                    ...
                    userVote === 'like' ? "bg-ios-blue text-white" : "bg-black/5 text-ios-gray hover:bg-ios-blue/10 hover:text-ios-blue"
                  )}
                >
                  <ThumbsUp size={32} />
                </button>
                <div className="text-center">
                  <span className="block text-3xl font-bold text-black">{votes.likes}</span>
              ...
              <div className="flex flex-col items-center space-y-4">
                <button
                  ...
                  className={cn(
                    "p-6 rounded-3xl transition-all duration-300 transform hover:scale-110 shadow-lg",
                    userVote === 'dislike' ? "bg-red-500 text-white" : "bg-black/5 text-ios-gray hover:bg-red-500/10 hover:text-red-500"
                  )}
                >
                  <ThumbsDown size={32} />
                </button>
                <div className="text-center">
                  <span className="block text-3xl font-bold text-black">{votes.dislikes}</span>
          ...
          >
            ...
            <div className="text-center w-full">
              <div className="text-6xl font-bold text-black mb-2 tracking-tighter">{averageRating}</div>
                ...
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    className={cn(
                      ...
                      (userRating && star <= userRating) ? "text-yellow-500" : "text-black/10 hover:text-yellow-500/50"
                    )}
                  >
