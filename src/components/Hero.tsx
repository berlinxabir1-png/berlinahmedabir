    ...
    <section id="home" className="min-h-screen flex items-center justify-center pt-32 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <div className="mb-8">
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-black leading-[0.9] tracking-tighter text-black mb-4">
              <span className="block opacity-50 text-3xl sm:text-4xl md:text-5xl font-bold mb-2">I'm</span>
              <div className="flex flex-wrap">
                {profile.name.split(" ").map((word: string, i: number) => (
                  <motion.span
                    ...
                    className={i === 0 ? "text-ios-blue mr-3 sm:mr-4" : "text-black mr-3 sm:mr-4"}
                  >
                    {word}
                  </motion.span>
                ))}
            ...
            <div className="h-10 sm:h-12 flex items-center">
              <span className="text-xl sm:text-2xl md:text-4xl text-ios-gray font-semibold">
                A{' '}
                <span className="text-black border-b-2 sm:border-b-4 border-ios-blue/30 pb-1">
                  <Typewriter
          ...
          <motion.p 
            ...
            className="text-lg sm:text-xl text-ios-gray max-w-lg mb-10 sm:mb-12 leading-relaxed font-medium"
          >
            {profile.description}
          </motion.p>
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6">
            <motion.button
              ...
              className="ios-button-primary flex items-center space-x-3 px-6 sm:px-8 py-4 sm:py-5 text-base sm:text-lg shadow-xl shadow-ios-blue/20"
            >
            ...
            <motion.button
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              className="ios-button-secondary flex items-center space-x-3 px-6 sm:px-8 py-4 sm:py-5 text-base sm:text-lg"
            >
              <Download size={20} />
        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 md:w-[450px] md:h-[450px] rounded-[24%] overflow-hidden border-[8px] sm:border-[12px] border-white shadow-2xl transform transition-transform duration-700 group-hover:scale-[1.02] group-hover:rotate-1">
              <img 
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 sm:-top-10 sm:-right-10 ios-glass p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl z-20 border-white/40 min-w-[140px] sm:min-w-[180px]"
            >
              <div className="flex items-center space-x-2 sm:space-x-3 mb-2 sm:mb-3">
                <div className="p-1.5 sm:p-2 bg-ios-blue/10 rounded-xl">
                  <Cake size={16} className="sm:size-5 text-ios-blue" />
                </div>
                <div className="text-ios-blue font-extrabold text-[12px] sm:text-sm tracking-tight">Birthday</div>
              </div>
              <div className="text-[10px] sm:text-xs text-ios-gray font-bold mb-2 sm:mb-3 opacity-70">
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 sm:-bottom-8 sm:-left-12 ios-glass p-4 sm:p-6 rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl border-white/40"
            >
              <div className="flex flex-col">
                <span className="text-ios-blue font-black text-2xl sm:text-4xl leading-none">{profile.projects_count}</span>
                <span className="text-[8px] sm:text-[10px] text-ios-gray font-black uppercase tracking-[0.2em] mt-1">Projects Done</span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute bottom-6 -right-3 sm:bottom-10 sm:-right-6 ios-glass py-2 sm:py-3 px-4 sm:px-5 rounded-xl sm:rounded-2xl shadow-xl border-white/40 flex items-center space-x-2 sm:space-x-3"
            >
