...
const navLinks = [
  ...
  { name: 'Subject', href: '#favorite-subject' },
    ...
    >
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <span className="text-black hidden sm:inline">Berlin Ahmed Abir</span>
        </motion.a>
        ...
        <div className="hidden md:flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-4 ml-4 border-l border-black/5 pl-6">
            ...
            <div className="flex flex-col p-6 space-y-4">
              {navLinks.map((link) => (
                <a
                  ...
                  className="text-lg font-semibold text-black hover:text-ios-blue transition-colors"
                >
                  {link.name}
                </a>
              ))}
