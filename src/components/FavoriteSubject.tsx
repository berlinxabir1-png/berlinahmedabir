    ...
    <section id="favorite-subject" className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="ios-card bg-gradient-to-br from-ios-blue/5 to-indigo-500/5 border-ios-blue/10 p-6 sm:p-12 relative overflow-hidden group"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              ...
              <p className="text-ios-gray text-base sm:text-lg font-medium leading-relaxed mb-8">
              ...
              <div className="flex flex-wrap gap-3 sm:gap-4">
                {subject.tags.map(tag => {
                  ...
                  return (
                    <div key={tag} className="flex items-center space-x-2 px-3 sm:px-4 py-2 bg-white/50 rounded-xl border border-black/5 shadow-sm">
                      <Icon size={16} className="text-ios-blue" />
                      <span className="text-xs sm:text-sm font-bold text-black">{tag}</span>
                    </div>
                  );
                })}
              </div>
